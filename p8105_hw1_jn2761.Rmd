...
There are `r ncol(penguins)` variables in the dataset "penguins" they are `r variable.names(penguins)`. The data contains total of `r nrow(penguins)` observations. The mean flipper length is `r mean(pull(penguins,flipper_length_mm))`
